...
##                    stand
## pitch_type_full       L   R
##   Four-seam FB      304 544
##   Fastball (cutter) 208 272
##   Sinker             32 176
##   Changeup           16  48
##   Curveball          96 192
```
...
##   Four-seam FB      160  80 208  64  48 128  64  96
##   Fastball (cutter)  48  48  64  48  80  96  48  48
##   Sinker             32  16  16  16  16  32  16  64
##   Changeup            0  16   0  16  16  16   0   0
##   Curveball          32  48  16  32   0  48  32  80
```
...
```
## Error in eigen(hess, symmetric = TRUE): 0 x 0 matrix
```
...
```
## Error in do.call(fun, expr): could not find function "m1"
```
