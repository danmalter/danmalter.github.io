...
Graph the count of pitch type by pitch descriptionl.  Only 'Ball', 'Swinging Strike' and 'Called Strike' are being used, 
many other types of descriptions are recorded.
