...
With the tragic loss of Kobe Bryant and his daughter Gianna, we reflect on his dominant career with the Lakers by showcasing his remarkable 20 seasons in the NBA.  Using the ggplot2 library in R and leveraging data from [Kaggle's Kobe Bryant Shot Selection competition](https://www.kaggle.com/c/kobe-bryant-shot-selection), we’ve created several data visualizations that display his achievements.  
